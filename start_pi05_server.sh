...
cd "$repo"
mkdir -p logs
cp /mnt/c/Users/user/Desktop/跑跑/pi05_libero_rtx5090.yaml configs/model_servers/lerobot/pi05_libero_rtx5090.yaml
...
for attempt in $(seq 1 120); do
  ...
  if (( attempt % 6 == 0 )); then
    echo "waiting for model server: $((attempt * 5))s"
